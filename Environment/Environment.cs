		...
		else
		{
			...
			switch (biomeId)
			{
				case 1:
					...
					_env = ResourceLoader.Load("res://BiomeEnvironments/ForestEnvironment.tres");
				...
				case 2:
					...
					_env = ResourceLoader.Load("res://BiomeEnvironments/DarkForestEnvironment.tres");
					Environment = (Godot.Environment)_env;
					break;
				case 3:
					...
					_env = ResourceLoader.Load("res://BiomeEnvironments/SnowEnvironment.tres");
					Environment = (Godot.Environment)_env;
					break;
				case 4:
				...
				case 5:
					...
					_env = ResourceLoader.Load("res://BiomeEnvironments/DesertEnvironment.tres");
					Environment = (Godot.Environment)_env;
					break;
