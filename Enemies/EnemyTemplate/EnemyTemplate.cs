...
public partial class EnemyTemplate : CharacterBody2D
{
	...
	{
		var node = area.GetParent<PhysicsWeapon>();
	...
	protected virtual void GiveDeathRewards()
	{
		...
		AchievementsManager.I?.RegisterEnemyKilled(EnemyName);

		if (!string.IsNullOrWhiteSpace(EnemyName) &&
			EnemyName.Contains("Boss", StringComparison.OrdinalIgnoreCase))
		{
			AchievementsManager.I?.RegisterBossDefeated(EnemyName);
		}
	}
