...
namespace projecthorizonscs.Enemys.DryLeave;

public partial class DryLeave : EnemyTemplate.EnemyTemplate
{
		...
		switch (CurrentState)
		{
			case EnemyState.Idle:
				if (DistanceToPlayer < DetectionDistance)
				{
					...
					PlayerReference = projecthorizonscs.Autoload.Globals.I.LocalPlayer;
				}
				else
				{
